...
ItemInfo extends ArrayList {
    ...
    public ArrayList<String> iconLavel = new ArrayList<String>();
        ...
        for(ApplicationInfo ai : appInfoList){
            ...
            for (String str : mDisplayPackageList) {
                if(ai.packageName.equals(str)){
                    ...
                    mDispClass.set(i, pm.getLaunchIntentForPackage(ai.packageName).getComponent().getClassName());
                }
                i++;
            }
        }
